...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('auth/css/open-iconic-bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('auth/css/animate.css')}}">
    
    <link rel="stylesheet" href="{{asset('auth/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('auth/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('auth/css/magnific-popup.css')}}">

    <link rel="stylesheet" href="{{asset('auth/css/aos.css')}}">

    <link rel="stylesheet" href="{{asset('auth/css/ionicons.min.css')}}">

    <link rel="stylesheet" href="{{asset('auth/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('auth/css/jquery.timepicker.css')}}">

    
    <link rel="stylesheet" href="{{asset('auth/css/flaticon.css')}}">
    <link rel="stylesheet" href="{{asset('auth/css/icomoon.css')}}">
  ...
  <body>
    <div class="py-1 bg-black top">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">+ 09683472526</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index">Best Restaurant </a>
    ...
    <section class="home-slider owl-carousel js-fullheight">
      <div class="slider-item js-fullheight" style="background-image: url(auth/images/bg_1.jpg);">
      ...
      <div class="slider-item js-fullheight" style="background-image: url(auth/images/breakfast-3.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
      ...
      <div class="slider-item js-fullheight" style="background-image: url(auth/images/bg_3.jpg);">
      	<div class="overlay"></div>
        <div class="container">
  ...
  <script src="auth/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="auth/js/popper.min.js"></script>
  <script src="auth/js/bootstrap.min.js"></script>
  <script src="auth/js/jquery.easing.1.3.js"></script>
  <script src="auth/js/jquery.waypoints.min.js"></script>
  <script src="auth/js/jquery.stellar.min.js"></script>
  <script src="auth/js/owl.carousel.min.js"></script>
  <script src="auth/js/jquery.magnific-popup.min.js"></script>
  <script src="auth/js/aos.js"></script>
  <script src="auth/js/jquery.animateNumber.min.js"></script>
  <script src="auth/js/bootstrap-datepicker.js"></script>
  <script src="auth/js/jquery.timepicker.min.js"></script>
  <script src="auth/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="auth/js/google-map.js"></script>
